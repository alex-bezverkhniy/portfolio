...
/**
 * REST controller for managing {@link com.alexbezverkhniy.blogapi.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class PostResource {
    ...
    public ResponseEntity<List<Post>> searchPosts(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
